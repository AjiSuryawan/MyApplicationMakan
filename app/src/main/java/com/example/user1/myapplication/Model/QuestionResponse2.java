...
public class QuestionResponse2 extends RealmObject implements Parcelable {
    ...
    public QuestionResponse2() {
    }

    protected QuestionResponse2(Parcel in) {
        mgId = in.readString();
        id = in.readString();
    ...
    public static final Creator<QuestionResponse2> CREATOR = new Creator<QuestionResponse2>() {
        @Override
        public QuestionResponse2 createFromParcel(Parcel in) {
            return new QuestionResponse2(in);
        }

        @Override
        public QuestionResponse2[] newArray(int size) {
            return new QuestionResponse2[size];
        }
    };
